  ...
  <body">
    <div class="mb-28" >
      ...
      <div class="mt-[68px] flex items-center justify-center">
        <form action="/extensions/create" method="POST" class="flex flex-col items-start gap-5 bg-white p-5 rounded border-[#4245DB] border-4">
          @csrf
          ...
          <div class="flex flex-col w-[350px]">
            <label>Imagem</label>
            <input type="text" name="image" id="image" placeholder="Link da imagem" class="border-2 border-black rounded p-2">
          </div>
